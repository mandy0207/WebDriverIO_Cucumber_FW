...
exports.config = {
    ...
    //
    specs: [
        './features/**/*Validate_AddPerson.feature',
        './features/**/*.feature'
    ...
    beforeScenario: async () => {
       ...
       console.log("Before Scenario");
        ...
        // Get the login credentials from the configuration
       //const { username, password } = browser.config.loginCredentials;
       const usernameInput = await browser.$("//input[@id='login:usernameDecorate:username']");
     ...
     await browser.reloadSession();
      ...
      afterStep: async (uri, feature, { error, result, duration, passed }, step) => {
        // This code will run after each step
    
        // Take a screenshot if the step fails
        if (!passed) {
          const screenshotFilePath = path.join(
            `${feature.name}-${step.index}-failed.png`
          );
